                    ...
                    @else
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end  " aria-labelledby="navbarDropdown">
                                ...
                                <a href="#"
                                   class="sidebar-card    list-group-item list-group-item-action py-3 lh-tight">
                        ...
                        <div class="container-avatar pb-4 ">
                            <img src="{{ route('user.avatar',['filename'=>Auth::user()->image]) }}"
                                 class="avatar  rounded-circle align-middle" alt="avatar-img"/>
                        </div>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent2">
                    <ul class="navbar-nav mr-auto col-12">
                        ...
                        <li class="nav-item col-2 ">
                            <a class="nav-link" href="/career-posts">Carrera</a>
                        </li>
                        <li class="nav-item col-2 ">
                            <a class="nav-link" href="/partner-posts">Compañeros</a>
                        </li>
                        <li class="nav-item col-2 ">
